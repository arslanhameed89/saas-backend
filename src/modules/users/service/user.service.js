...
var database_symbols_1 = require("../../../core/database/database.symbols");
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.createUser = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (lodash_1.isEmpty(name) || lodash_1.isEmpty(email)) {
    ...
    UserService = __decorate([
        common_1.Injectable(),
        __param(0, common_1.Inject(database_symbols_1.CONNECTION))
    ], UserService);
    return UserService;
}());
