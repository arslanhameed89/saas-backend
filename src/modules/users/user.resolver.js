...
var create_user_output_1 = require("./dto/create-user.output");
var UserResolver = /** @class */ (function () {
    ...
    UserResolver.prototype.createUser = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.createUser(input)];
            });
        });
    };
    __decorate([
        graphql_1.Query(function (returns) { return [user_entity_1.User]; })
    ], UserResolver.prototype, "getUsers");
    __decorate([
        graphql_1.Mutation(function (returns) { return create_user_output_1.CreateUserOutput; }) // Specify the output type for the mutation
        ,
